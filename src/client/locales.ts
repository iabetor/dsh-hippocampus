...
export const zh = {
  ...
  'session.user': '全局记忆',
  'session.loading': '加载中…',
  'session.columns': '改为左右并列',
  'session.stack': '改为上下堆叠',
  'session.error': '加载失败',
  ...
  'settings.delete': '删除',
  'settings.copyNote': '复制为Note',
  'settings.copied': '已复制✓',
  'settings.copyAsNote': '复制为 Agent Note 格式的 markdown，粘贴到项目 docs/notes/',
  'settings.copyFallback': '复制以下 Note 内容（浏览器不支持剪贴板）:\n\n',
...
export const en: Record<string, string> = {
  ...
  'session.columns': 'Switch to side-by-side',
  'session.stack': 'Switch to stacked',
  ...
  'settings.copyNote': 'Copy as Note',
  'settings.copied': 'Copied✓',
  'settings.copyAsNote': 'Copy as Agent Note markdown; paste into the project docs/notes/',
  'settings.copyFallback': 'Copy this Note (clipboard unavailable):\n\n',
