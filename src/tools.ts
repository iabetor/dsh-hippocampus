...
const PROMPT_TEXT =
  ...
  + '\n2. If it is a design decision, a lesson, or a pitfall (the "why", what was given up), do NOT remember it — write a decision document (e.g. docs/YYYY-MM-DD-topic.md in the project docs/ folder) or suggest one to the user.'
  ...
  + '\n   - decision/lesson/pitfall → write a decision document with your write tool (path like docs/YYYY-MM-DD-topic.md in the project docs/ folder), then forget the memory or replace it with a one-line pointer to the document;'
